...
V0.5 improves the investigator-ready experience while preserving V0's governed local loop. Its foundational `InvestigationDirection` domain contracts, SQLite schema/persistence foundation, and safe configured case-catalog work are implemented locally; orchestration, model/preflight, lifecycle, and investigator UI work remain future V0.5 tasks. It does not authorize analytical execution.
